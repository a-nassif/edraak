...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('student_baytpublishedcertificate', (
        ...
        db.send_create_signal('student', ['BaytPublishedCertificate'])


    def backwards(self, orm):
        # Deleting model 'BaytPublishedCertificate'
        db.delete_table('student_baytpublishedcertificate')
    ...
    models = {
        ...
        'student.baytpublishedcertificate': {
